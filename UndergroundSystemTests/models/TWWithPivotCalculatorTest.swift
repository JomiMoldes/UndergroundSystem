...
class TWWithPivotCalculatorTest:XCTestCase {
...
// helpers
    ...
    private func makeSUT(provider:TWLinesAndStationsProvider) -> TWWithPivotCalculator {
        return TWWithPivotCalculator(provider:provider)
    }
